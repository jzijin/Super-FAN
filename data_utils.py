...
class TrainDatasetFromFolder(Dataset):
    def __init__(self, dataset_dir, crop_size, upscale_factor):
        ...
        self.image_filenames = [join(dataset_dir, x) for x in loadFromFile("train.list", 25000) if is_image_file(x)]
...
class ValDatasetFromFolder(Dataset):
    def __init__(self, dataset_dir, crop_size,  upscale_factor):
        ...
        self.image_filenames = [join(dataset_dir, x) for x in loadFromFile("test.list", 100) if is_image_file(x)]
